...
export default function Fonts(){
    return(
        <div className="bg-black w-full h-[122px] flex justify-center space-x-4 md:justify-between items-center px-3 flex-wrap">
            <h1 className={`${Playfair.className} text-whit text-2xl md:text-4xl`}>VERSACE</h1>
            ...
            <h1 className={`${Montserra.className} text-white text-2xl md:text-4xl`}>Calvin Klien</h1>
        </div>
    )
}
