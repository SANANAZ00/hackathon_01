        ...
        <main className="w-full h-full md:h-[500px] flex flex-col md:flex:row justify-between items-start bg-[#F2F0F1]">
            ...
            <div className=" w-full md:w-[500px] mt-3 md-mt-10 md:ml-10 pl-3">
             ...
             <div className="relative">
                <Image src={"/public/profile.png"} className="w-[500px] mr-4" width={200} height={200} alt="profile"></Image>
                {/* star */}
                <Image src={"/public/star.png"} className="w-[50px] md:w-[100px] absolute top-[100px] left-10 md:top-[300px] md:left-[-100px]" width={200} height={200} alt="profile"></Image>
                <Image src={"/public/star.png"} className="w-[60px] md:w-[100px] absolute top-0 right-[50px] md:top-[50px] md:right-[30px]" width={200} height={200} alt="profile"></Image>
             </div>
        </main>
    )
